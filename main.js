...
var author$project$LiveCoding$X = {$: 'X'};
var author$project$LiveCoding$gridSize = 3;
var author$project$LiveCoding$Nobody = {$: 'Nobody'};
var elm$core$Basics$False = {$: 'False'};
var author$project$LiveCoding$initCell = function (index) {
	return {index: index, isPlayed: false, player: author$project$LiveCoding$Nobody};
};
...
var author$project$LiveCoding$initialModel = function () {
	var indexes = A2(elm$core$List$range, 0, (author$project$LiveCoding$gridSize * author$project$LiveCoding$gridSize) - 1);
	var cells = A2(elm$core$List$map, author$project$LiveCoding$initCell, indexes);
	return {currentPlayer: author$project$LiveCoding$X, grid: cells};
}();
var author$project$LiveCoding$O = {$: 'O'};
...
var author$project$LiveCoding$update = F2(
	function (message, model) {
		var cell = message.a;
		var splitIndex = cell.index + 1;
		var playedCell = _Utils_update(
			cell,
			{isPlayed: true, player: model.currentPlayer});
		var nextPlayer = _Utils_eq(model.currentPlayer, author$project$LiveCoding$X) ? author$project$LiveCoding$O : author$project$LiveCoding$X;
		var newCellList = _Utils_ap(
			A2(elm$core$List$take, cell.index, model.grid),
			_Utils_ap(
				_List_fromArray(
					[playedCell]),
				A2(elm$core$List$drop, splitIndex, model.grid)));
		return _Utils_update(
			model,
			{currentPlayer: nextPlayer, grid: newCellList});
	});
var author$project$LiveCoding$Played = function (a) {
	return {$: 'Played', a: a};
};
var author$project$LiveCoding$viewPlayer = function (player) {
	switch (player.$) {
		case 'X':
			return 'X';
		case 'O':
...
var author$project$LiveCoding$viewCell = function (cell) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
				...
				author$project$LiveCoding$Played(cell))
			]),
		_List_fromArray(
			[
				elm$html$Html$text(
				author$project$LiveCoding$viewPlayer(cell.player))
			]));
};
var author$project$LiveCoding$viewRow = function (row) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		A2(elm$core$List$map, author$project$LiveCoding$viewCell, row));
};
...
var author$project$LiveCoding$viewGrid = function (grid) {
	return elm$core$List$isEmpty(grid) ? _List_fromArray(
		[
			A2(elm$html$Html$br, _List_Nil, _List_Nil)
		]) : A2(
		elm$core$List$cons,
		author$project$LiveCoding$viewRow(
			A2(elm$core$List$take, author$project$LiveCoding$gridSize, grid)),
		author$project$LiveCoding$viewGrid(
			A2(elm$core$List$drop, author$project$LiveCoding$gridSize, grid)));
};
var elm$html$Html$p = _VirtualDom_node('p');
var author$project$LiveCoding$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				elm$html$Html$div,
				_List_Nil,
				author$project$LiveCoding$viewGrid(model.grid)),
				A2(
				elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						elm$html$Html$text(
						'Next player: ' + author$project$LiveCoding$viewPlayer(model.currentPlayer))
					]))
			]));
};
...
var author$project$LiveCoding$main = elm$browser$Browser$sandbox(
	{init: author$project$LiveCoding$initialModel, update: author$project$LiveCoding$update, view: author$project$LiveCoding$view});
_Platform_export({'LiveCoding':{'init':author$project$LiveCoding$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"LiveCoding.Msg","aliases":{"LiveCoding.Cell":{"args":[],"type":"{ player : LiveCoding.Player, isPlayed : Basics.Bool, index : Basics.Int }"}},"unions":{"LiveCoding.Msg":{"args":[],"tags":{"Played":["LiveCoding.Cell"]}},"LiveCoding.Player":{"args":[],"tags":{"X":[],"O":[],"Nobody":[]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));